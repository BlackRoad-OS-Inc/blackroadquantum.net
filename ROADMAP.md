# ROADMAP — blackroadquantum.net

> Product roadmap for BlackRoad Quantum Net
...
- [ ] Deploy index.html to blackroadquantum.net
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroadquantum.net with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: BlackBox Protocol, Tor Hidden Services, IPFS Nodes, Mesh SDK
...
**Milestone**: First paying customer through blackroadquantum.net.
...
**Milestone**: blackroadquantum.net is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: security | Products: BlackBox Protocol, Tor Hidden Services, IPFS Nodes, Mesh SDK*
